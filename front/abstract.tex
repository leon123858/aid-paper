...
我們針對身分管理系統中存在的安全風險和信任問題進行深入研究，並提出了一種全新的解決方案——自主身分識別。傳統的身分管理系統雖然已經足夠實用，但其對中心化中介者的依賴造就了更高的安全風險與更低的可信任性。本研究的核心概念是將身分識別的控制權交還給用戶，使其能夠更主動地管理自己的身分資訊，從而提升系統的安全性與可信任性。
